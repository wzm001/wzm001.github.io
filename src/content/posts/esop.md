...
![ESOP 的业务模块](/images/esop-business.png)
...
![授予的生命周期](/images/grant-lifecycle.png)
...
![ESOP 的服务架构](/images/esop-services.png)
...
### [ESOP-Push](https://wzm001.github.io/posts/esop-push/)

消息推送服务。负责处理各个渠道的消息推送，例如邮件、短信等，封装业务模版，尽量做到和业务系统解耦。

### [ESOP-Sign](https://wzm001.github.io/posts/esop-sign/)

在线签署服务。负责处理业务流程中的合同签署场景。整个 ESOP 业务中涉及到很多需要签署协议的场景。

### [ESOP-KMS](https://wzm001.github.io/posts/esop-kms/)
