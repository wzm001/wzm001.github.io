...
2. 合同等敏感数据可以由业务方自行管理，满足行业相关的合规要求；
   但这样做也有坏处：
3. 上上签 SDK 是一个黑盒，业务方无法控制其行为，必须依赖上上签的定期升级；
4. 虽然数据由业务方自行管理，但必须依赖上上签 SDK 访问，经过 SDK 的数据丢失了业务属性，无法单独利用；

![上上签混合云架构](/images/bestsign.png)
...
![Esop-sign 基于上上签的架构](/images/esop-sign.png)
...
![esop sign](/images/sign-arch.png)
...
![签署服务如何处理文件](/images/sign-file.png)

具体的处理逻辑：
![esop sign file](/images/sign-file2.png)
